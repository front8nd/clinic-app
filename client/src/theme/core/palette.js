import COLORS from './colors.json'; // Importing color definitions from a JSON file.
import { varAlpha, createPaletteChannel } from '../styles'; // Importing utility functions for creating color channels.
