import { grey } from './palette'; // Importing grey colors from the palette.
import { varAlpha } from '../styles'; // Importing utility function for alpha color manipulation.

// ----------------------------------------------------------------------

// Function to generate shadow styles
export function shadows() {
  const colorChannel = grey['500Channel']; // Get the channel color.

  const color1 = varAlpha(colorChannel, 0.2); // Define shadow color levels.
